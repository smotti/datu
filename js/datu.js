...
var _user$project$Messages$StopTimer = {ctor: 'StopTimer'};
var _user$project$Messages$StartTimer = {ctor: 'StartTimer'};
			...
			case 'ToggleTimerSettings':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showSettings: model.showSettings ? false : true
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Tick':
...
var _user$project$Views$viewTimerSettingsChevron = function (show) {
	return show ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-chevron-up'),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-chevron-down'),
				A2(_elm_lang$html$Html_Attributes$attribute, 'aria-hidden', 'true')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Views$viewTimerSettings = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('btn col-xs-12 col-md-12'),
								...
								A2(_elm_lang$html$Html_Attributes$attribute, 'aria-controls', 'settingsCollapsable'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'text-align', _1: 'center'}
									])),
								_elm_lang$html$Html_Events$onClick(_user$project$Messages$ToggleTimerSettings)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Views$viewTimerSettingsChevron(model.showSettings)
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('row collapse'),
						_elm_lang$html$Html_Attributes$id('settings'),
						_elm_lang$html$Html_Attributes$style(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'text-align', _1: 'center'}
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-xs-4 col-md-4')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Pomodoro Timer')
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('SB Timer')
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('LB Timer')
							]))
					]))
			]));
};
var _user$project$Views$viewPlayButton = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.timerEnabled ? {ctor: '_Tuple2', _0: _user$project$Messages$StopTimer, _1: 'glyphicon-stop'} : {ctor: '_Tuple2', _0: _user$project$Messages$StartTimer, _1: 'glyphicon-play'};
	var msg = _p2._0;
	var glyph = _p2._1;
	return A2(
		_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$Basics_ops['++'], 'glyphicon ', glyph)),
								A2(_elm_lang$html$Html_Attributes$attribute, 'aria-hidden', 'true')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
...
var _user$project$Datu$init = {ctor: '_Tuple2', _0: _user$project$Models$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Datu$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Datu$init, update: _user$project$Update$update, view: _user$project$Views$viewPomodoro, subscriptions: _user$project$Update$subscriptions})
};
